...
import VfsLogoCopy from "../components/VfsLogoCopy";
import UrnFormCopy from "../components/UrnFormCopy";
import FaqAccordionCopy from "../components/FaqAccordionCopy";
import WidgetCaptureCopy from "./WidgetCaptureCopy";
            ...
            <div className="w-full max-w-md p-6 border border-gray-200 rounded-lg shadow-sm bg-white">
              {!showWidget ? (
                <>
                  ...
                  <UrnFormCopy onSubmit={handleUrnSubmit} />
                </>
              ) : (
                <>
